...
function galleryJackSettings() {
	...
	socialSettings = {
		...
		/* Set this to an empty string to not use */
		twitterIcon: "<div id='cj-twitter-icon'><a href='http://twitter.com/{twitterUser}' target='_blank'><img src='../images/PictureGalleryShowingGraphics/twitter.png' width='20' height='20' /></a></div>",
				
		/* Set this to an empty string to not use */
		facebookIcon: "<div id='cj-facebook-icon'><a href='http://www.facebook.com/{facebookUser}' target='_blank'><img src='../images/PictureGalleryShowingGraphics/facebook.png' width='20' height='20' /></a></div>",
	...
	ajaxSettings = {
		...
		imagePath: "../../UserUploadedPictures/photos/",
