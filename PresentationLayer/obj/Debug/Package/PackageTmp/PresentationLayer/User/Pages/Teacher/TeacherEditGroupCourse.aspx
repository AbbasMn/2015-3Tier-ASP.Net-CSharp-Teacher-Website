<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherEditGroupCourse.aspx.cs" Inherits="PresentationLayer.User.Pages.Teacher.TeacherEditGroupCourse" %>
         ...
         <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>      
                            ...
                            <table Class="TableMy">
                                ...
                                <tr>
                                    <td align="right" class="style20" colspan="6">
                                        <b>ویرایش اطلاعات&nbsp;درس ارائه شده توسط استاد&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <tr>
                                    <td align="right" class="style20" rowspan="2" valign="top">
                                ...
                                <tr>
                                    ...
                                    <td align="right" class="style20">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                            ControlToValidate="drliUniversity" Display="Dynamic" 
                                            ErrorMessage="دانشگاه ارائه دهنده را وارد نماييد" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="drliUniversity" runat="server" CssClass="InputControl" 
                                            DataTextField="UniversityName" Height="20px" TabIndex="3" Width="130px">
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right" class="style20">
                                        دانشکده:</td>
                                    <td align="right" class="style19">
                                        <asp:Label ID="lblCourseFacultyName" runat="server" CssClass="LableMy" 
                                            Text="Label" Width="100%"></asp:Label>
                                    </td>
                                    <td align="right" class="style18">
                                        ارائه براي رشته:</td>
                                    <td align="right">
                                        <asp:Label ID="lblCourseEducationBranchName" runat="server" CssClass="LableMy" 
                                            Text="Label" Width="100%"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="right" class="style20">
                                        <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" 
                                            CssClass="LinkButtonMy" Font-Underline="True" 
                                            PostBackUrl="~/PresentationLayer/User/Pages/Teacher/TeacherAddCourse.aspx" 
                                            TabIndex="5">تعريف درس جديد</asp:LinkButton>
                                    </td>
                                    <td align="right" class="style20">
                                        تعداد واحد تئوري:</td>
                                    <td align="right" class="style19">
                                ...
                                <tr>
                                    ...
                                    <td align="right" class="style20">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                            ControlToValidate="drliCourse" Display="Dynamic" 
                                            ErrorMessage="درس را وارد نماييد" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="drliCourse" runat="server" AutoPostBack="True" 
                                            CssClass="InputControl" DataTextField="CourseName" Height="20px" 
                                            ontextchanged="drliCourse_TextChanged" TabIndex="4" Width="130px">
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right" class="style20">
                                        شماره درس:</td>
                                    <td align="right" class="style19">
                                        <asp:Label ID="lblCourseID" runat="server" CssClass="LableMy" Text="Label" 
                                            Width="100%"></asp:Label>
                                    </td>
                                    <td align="right" class="style18">
                                        ترم ارائه درس:</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnSave" runat="server" CssClass="Button" 
                                            onclick="btnSave_Click" style="margin-right: 0px" TabIndex="16" Text="ويرايش" 
                                            Width="50px" />
                                    </td>
                                </tr>
                            </table>
