<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherShowStudentResponseMessages.aspx.cs" Inherits="PresentationLayer.User.Pages.Teacher.TeacherShowStudentResponseMessages" %>
                ...
                <tr>
                 ...
                 <ItemTemplate>
                    ...
                    <div class="internalDivContainMessageMy">
                            ...
                            <pMessageMy>
                            <label id="lbl1" class="LableMy">پيام شما:  <%#Eval("messageDate")%></label>
                            <br />
                               <%#Eval("messagePassage")%> 
                            </pMessageMy>
                            ...
                            <hr class="internalDivLineMessageMy" /> 
                            <pMessageMy>
                            <label id="lbl2" class="LableMy">پاسخ: <%#Eval("messageResponseDate")%></label>
                            <br />
