<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSendResponseToStudent.aspx.cs" Inherits="PresentationLayer.Admin.AdminContentPages.AdminSendResponseToStudent" %>
...
<div class="four_equals">
            ...
            <table style="width: 100%">
             ...
             <li><a href="AdminSetStudentPermission.aspx">سطح دسترس</a></li>
        ...
        <asp:Label ID="lblMessage" runat="server" CssClass="LableMy"></asp:Label>
           ...
           <asp:Label ID="lblError" runat="server" CssClass="LableMy"></asp:Label>
                ...
                <table border="0" cellpadding="1" cellspacing="0" Class="TableMy" align="center" 
                    ...
                    <tr>
                        <td class="style17" valign="top" align="right" colspan="4">
                    ...
                    <tr>
                        <td class="style17" valign="top" align="right" colspan="4">
                            &nbsp;</tr>
                    <tr>
                        <td class="style17" valign="top" align="left" colspan="4">
