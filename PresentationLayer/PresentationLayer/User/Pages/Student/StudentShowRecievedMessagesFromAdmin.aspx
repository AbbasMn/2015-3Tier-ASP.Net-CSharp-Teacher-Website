<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="StudentMainMP.Master" CodeBehind="StudentShowRecievedMessagesFromAdmin.aspx.cs" Inherits="PresentationLayer.User.Pages.Student.StudentShowRecievedMessagesFromAdmin" %>
               ...
               <HeaderTemplate>
                 ...
                 <ItemTemplate>
                    ...
                    <a class="internalDivMessageMyfooterlogoLeft">
                            ...
                            <label id="lbl2" class="LableMyBold">پاسخ شما:</label>
                            
                             <%#Eval("messageResponseDate")%>
