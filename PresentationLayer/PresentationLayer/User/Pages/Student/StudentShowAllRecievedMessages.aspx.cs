...
{
    public partial class StudentShowAllRecievedMessages : System.Web.UI.Page
    {
        ...
        protected void showSendAndRecieveMessagesUnResponsed()
        {
            ...
            repeater1.DataSource = msg.showMessage(" * ", " messageStudentID=" + Session["StudentID"].ToString().Trim() +
        ...
        protected void showSendAndRecieveMessagesResponsed()
        {
            Message msg = new Message();
        ...
        protected void showSendAndRecieveMessagesAll()
        {
            Message msg = new Message();
        ...
        protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (RadioButtonList1.SelectedIndex == 0)
                showSendAndRecieveMessagesAll();

            else if (RadioButtonList1.SelectedIndex == 1)
                showSendAndRecieveMessagesResponsed();

            else showSendAndRecieveMessagesUnResponsed();
