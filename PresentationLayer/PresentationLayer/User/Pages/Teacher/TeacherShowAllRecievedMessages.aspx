<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherShowAllRecievedMessages.aspx.cs" Inherits="PresentationLayer.User.Pages.Teacher.TeacherShowAllRecievedMessages" %>
                 ...
                 <ItemTemplate>
                    ...
                    <div class="internalDivContainMessageMy">
                            ...
                            <%#Eval("messageSenderName")%> <%#Eval("messageSenderLastName")%> - <%#Eval("messageDate")%>
                                 ...
                                 <asp:ImageButton ID="ImageButton2" runat="server" CommandName="goToDelete" 
                                    ImageUrl="~/PresentationLayer/images/Icons/delete.png" ToolTip="حذف پيام" />                                       
                                 </a>
